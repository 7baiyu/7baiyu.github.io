...
我们可以通过sizeof函数来求一个数组的大小和长度。
            ...
            `#include <stdio.h> int main() {     int arr[] = { 1,2,3,4,5 };     int n = sizeof(arr);     int m = sizeof(arr) / sizeof(arr[0]);     return 0; }`
